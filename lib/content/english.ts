      ...
      lessons: [
        {
          ...
          tasks: [
            ...
            { id: "ps-rule-t12", type: "multiple_choice", speakOptions: true, prompt: "'I ___ apples.' (like)", options: ["like", "likes", "liking", "liked"], correctIndex: 0, xp: 15 },
          ],
          bonusTasks: [
      ...
      lessons: [
        {
          ...
          tasks: [
            ...
            { id: "ps-read-t10", type: "multiple_choice", speakOptions: true, prompt: "Mətn kimin haqqındadır?", options: ["Tom", "Leyla", "Anna", "Ali"], correctIndex: 1, xp: 15 },
          ],
          bonusTasks: [
